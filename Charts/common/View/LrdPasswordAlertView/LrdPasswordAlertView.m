...
- (void)setTitleName:(NSString *)titleName {
    ...
    [self.centerView mas_updateConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(@(200 + newSize.height - oldSize.height));
    }];
...
- (void)setFontSize:(CGFloat)fontSize {
    ...
    self.msgLabel.font = [UIFont boldSystemFontOfSize:fontSize];
}
...
- (void)setMsg:(NSString *)msg{
    ...
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    dict[NSFontAttributeName] = [UIFont boldSystemFontOfSize:17];
//    CGSize oldSize = [self.msgLabel.text boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil].size;
    //获取新的label的高度
    _msg = msg;
    ...
    dict[NSFontAttributeName] = font;
    //获取设置字体和字号之后的size
    CGSize newSize = [self.msgLabel.text boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dict context:nil].size;
    //根据计算的高度更新约束
//    [self.centerView mas_updateConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(self.mas_top).offset(150);
//        make.left.equalTo(self.mas_left).offset(50);
...
- (void)setAmout:(NSString *)amout {
    ...
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    dict[NSFontAttributeName] = [UIFont boldSystemFontOfSize:17];
//    CGSize oldSize = [self.amountLabel.text boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil].size;
    //获取新的label的高度
    _amout = amout;
    self.amountLabel.text = amout;
    UIFont *font = [UIFont boldSystemFontOfSize:17];
    if (self.fontSize) {
        font = [UIFont boldSystemFontOfSize:self.fontSize];
    }
    dict[NSFontAttributeName] = font;
    //获取设置字体和字号之后的size
    CGSize newSize = [self.amountLabel.text boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dict context:nil].size;
    //根据计算的高度更新约束
//    [self.centerView mas_updateConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(self.mas_top).offset(150);
//        make.left.equalTo(self.mas_left).offset(50);
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.msgLabel.text = @"请输入交易密码";
        self.msgLabel.textAlignment = NSTextAlignmentCenter;
        self.msgLabel.font = [UIFont boldSystemFontOfSize:17];
        ...
        [self.closeBuuton setImage:[UIImage imageNamed:@"close_button"] forState:UIControlStateNormal];
...
- (void) closeWindow {
    ...
    self.block(self.inputTextFiled.text);
