...
//----------------------------------美国的省地市关系图0,1,2--------------------------------------------
    ...
    Node *city10 = [[Node alloc] initWithParentId:15 nodeId:21 name:@"旧金山1" depth:3 expand:NO];
    Node *city11 = [[Node alloc] initWithParentId:15 nodeId:22 name:@"旧金山2" depth:3 expand:NO];
    Node *city123 = [[Node alloc] initWithParentId:21 nodeId:16 name:@"旧金山22" depth:4 expand:NO];
    Node *city234 = [[Node alloc] initWithParentId:21 nodeId:16 name:@"旧金山223" depth:4 expand:NO];
...
//----------------------------------日本的省地市关系图0,1,2--------------------------------------------
    ...
    NSArray *data = [NSArray arrayWithObjects:country1,province1,city1,city2,city3,province2,city4,city5,province3,city6,country2,province4,province5,city7,province6,city8,city9,country3,province7,province8,province9,city10,city11,city123,city234, nil];
