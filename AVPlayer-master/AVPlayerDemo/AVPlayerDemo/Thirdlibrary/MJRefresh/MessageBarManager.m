...
#define kMessageBarPadding 5
#define kMessageBarMaxDescriptionHeight 250
#define kMessageBarIconSize 26
#define kMessageBarDisplayDelay 2
#define kMessageBarTextOffset 2.0
#define kMessageBarAnimationDuration 0.35
...
- (id)initWithTitle:(NSString*)title description:(NSString*)description type:(MessageBarMessageType)type 
{
    ...
    if (self){
        ...
        descriptionFont = [UIFont systemFontOfSize:11.0];
...
- (void)drawRect:(CGRect)rect
{
    ...
    [titleColor set];
	[_titleString drawInRect:CGRectMake(xOffset+5, yOffset, titleLabelSize.width, titleLabelSize.height) withFont:titleFont lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentLeft];
	...
	[_descriptionString drawInRect:CGRectMake(xOffset+5, yOffset, descriptionLabelSize.width, descriptionLabelSize.height) withFont:descriptionFont lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentLeft];
...
- (void)showTopMessage:(NSString*)title description:(NSString*)description type:(MessageBarMessageType)type forDuration:(CGFloat)duration callback:(void (^)())callback
{
    MessageView *messageView = [[MessageView alloc] initWithTitle:title description:description type:type];
    ...
    [[MessageBarManager sharedInstance].messageBarQueue addObject:messageView];
    
    if (![MessageBarManager sharedInstance].messageVisible){
        [[MessageBarManager sharedInstance] showNextMessage];
    }
}

- (void)showTopMessage:(NSString*)title description:(NSString*)description type:(MessageBarMessageType)type
{
    [self showTopMessage:title description:description type:type forDuration:[MessageBarManager durationForMessageType:type] callback:nil];
}
